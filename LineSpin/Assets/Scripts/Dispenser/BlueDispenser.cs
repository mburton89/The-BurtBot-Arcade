...
public class BlueDispenser : MonoBehaviour {
...
//	private Vector3 Right2ProjectileSpawnLocation = new Vector3 (9.522f, 5, 0);
	...
	private Vector3 Left2ProjectileSpawnLocation = new Vector3 (-8f, 6.5f, 0);      
	private Vector3 Right1ProjectileSpawnLocation = new Vector3 (8f, 6.5f, 0);  
	private Vector3 Right2ProjectileSpawnLocation = new Vector3 (9.5f, 5, 0);
