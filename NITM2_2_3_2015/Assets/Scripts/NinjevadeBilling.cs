...
public class NinjevadeBilling : MonoBehaviour{   

	public string supportive = "CgkImaiNpJgYEAIQFg";
...
//		}
		...
		public void onMarketPurchase(PurchasableVirtualItem pvi, string payload, Dictionary<string, string> extra) {
			...
			Social.ReportProgress(supportive, 100.0f,(bool success) => {
